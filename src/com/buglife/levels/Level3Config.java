...
public class Level3Config implements LevelConfig {
    ...
    public Point getPlayerSpawn() {
        // TODO: Set spawn for Level 3 map
    ...
    public List<SpiderPatrolData> getSpiderPatrols() {
        // TODO: Add spider patrols for Level 3
    ...
    public List<SnailLocationData> getSnailLocations() {
        // TODO: Add snail locations for Level 3
        return Arrays.asList(
            // Example:
            // SnailLocationData.at(100, 100)
            //     .withDialogue("Welcome to Level 3!")
            //     .requiresInteraction()
        );
    }
    ...
    public List<FoodSpawnData> getFoodSpawns() {
        // TODO: Add food spawns for Level 3
        return Arrays.asList(
            // Example:
