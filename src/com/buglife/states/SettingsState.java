...
public class SettingsState extends GameState {
    ...
    private int returnState; // Track which state we came from
    ...
    public SettingsState(GameStateManager manager, SoundManager soundManager) {
        ...
        this.returnState = GameStateManager.MENU; // Default to menu
    }
    ...
    public void setReturnState(int state) {
